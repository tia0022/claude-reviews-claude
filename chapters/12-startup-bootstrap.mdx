---
title: "12 — Startup & Bootstrap"
description: "Cold start sequence — environment detection, config loading, and initialization order."
---
...
![12 startup bootstrap](/images/12-startup-bootstrap.svg)
